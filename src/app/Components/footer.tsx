...
const Footer = () => {
  return (
    ...
    <div className='flex bg-black text-white w-[1240px] h-[180px] justify-between ml-12
      pt-[36px] pr-[64px] pb-[36px] pl-[64px] rounded-[20px] absolute-top-[3781px] left-[100px] mt-20'>
    <div className='text-4xl w-[551px] h-[94px] font-black pt-3' >STAY UPTO DATE ABOUT OUR LATEST OFFERS</div>
    
    <div className='w-[349px] h-[108px] mt-2 '>
      <div className='flex items-center bg-white border rounded-[62px] h-9 w-[349px] pt-[12px] pr-[16[x] pb-[12px] 
           mb-4 pl-[16px]' >
...
<input
    ...
    <h1 className='w-[248px] h-[177px] text-[12px]'>
      <b className='font-black text-[33.45px]'>SHOP.CO </b><br />
    We have clothes that suits your style and which you’re proud to wear. From women to men.<br />
    ...
    <div className=' w-[104px] h-[177px] pt-2'>
      <h3><b className='font-normal text-[20px]'>COMPANY</b><br/>
    ...
    <h3><b className='font-normal text-[20px]'>HELP</b><br/>
    <div className='text-xs pt-6 '>
    ...
    <h3><b className='font-normal text-[20px]'>FAQ</b><br/>
    <div className='text-xs pt-6 '>
      <p>Account</p>  <br/>      
    ...
    <div className=' w-[149px] h-[177px] pt-2'>
    <h3><b className='font-normal text-[20px]'>RESOURCES</b><br/>
    <div className='text-xs pt-6 '>
      <p>Free eBooks</p>  <br/>      
