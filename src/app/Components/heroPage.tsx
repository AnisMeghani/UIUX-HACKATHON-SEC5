  ...
  return (
    <div className=' flex h-[663px] w-full '>
        ...
        <div className='py-24 pl-10'>
            <h1 className='text-6xl font-bold py-5 pr-1'>FIND CLOTHES THAT MATCHES YOUR STYLE</h1>
            <h6 className='text-xs pb-5 pr-6 text-gray-500'>
                Browse through our diverse range of meticulously crafted garments, designed to bring out your
                individuality and cater to your sense of style.
                </h6>
                <button className='bg-black text-white rounded-3xl py-2 px-14'>Shop Now</button>
            </div>
        </div>
